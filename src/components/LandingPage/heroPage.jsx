            ...
            <div className="flex justify-between px-4 md:px-8 lg:pe-24 lg:pt-16 lg:ps-20 lg:pe-12">
                <div className="pt-[120px] md:mx-auto lg:mx-0  md:pt-[150px] xl:pt-[100px] mid-2xl:pt-[130px]  lg:group-hover:scale-110 xl:group-hover:scale-105 2xl:group-hover:scale-110 group-hover:origin-left transition-transform duration-500 ease-in-out">
                    <div className="flex flex-col   justify-center lg:justify-start lg:items-start">
                        <h1 className="whitespace-pre-line text-center md:text-start font-extrabold font-jakarta-sans text-[28px] md:text-[48px] lg:text-[58px] xl:text-[48px] 2xl:text-[58px] leading-[120%] bg-gradient-to-r from-[#012169] to-[#041233] bg-clip-text text-transparent">
                        Work & Settle in the UK {"\n"} No Sponsor Needed
                        </h1>
                    </div>
                    <div className="hidden lg:block text-[14px] md:text-[18px] lg:text-[20px] font-jakarta-sans text-center lg:text-start font-medium text-[#2C2C2C] mt-6">
                        <p>Turn your talent into a Global Talent Visa with expert guidance,  <br/> AI-powered tools , and a clear path to permanent residency.</p>
                    </div>
                    <div className=" block lg:hidden px-4 text-[14px] md:text-[18px] lg:text-[20px] font-jakarta-sans text-center lg:text-start font-medium text-[#2C2C2C] mt-6">
                        <p>Turn your talent into a Global Talent Visa with expert guidance, AI-powered tools , and a clear path to permanent residency.</p>
                    </div>
                    {/* Buttons */}

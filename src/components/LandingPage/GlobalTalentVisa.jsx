    ...
    const ContentCard = ({ title, description, reverse = false }) => {
        ...
        return (<>
            <div className={`flex justify-between items-center gap-6 ${reverse ? 'flex-col-reverse md:flex-row-reverse' : 'flex-col-reverse md:flex-row'}`}>
                ...
                {
                    reverse ? <div className="bg-white p-6 shadow-lg w-[350px] h-[200px] md:w-[350px] md:h-[200px] lg:w-[403px] lg:h-[261px] rounded-lg relative">
                    ...
                    </div> : <div className="bg-white p-6 shadow-lg  w-[350px] h-[200px] md:w-[350px] md:h-[200px]  lg:w-[403px] lg:h-[261px] rounded-lg relative">

  ...
  return (
    <div ref={disclaimerRef} className="bg-[#007EE8] font-jakarta-sans text-white   flex flex-col md:flex-row justify-between items-center   py-8 px-8 md:py-12 md:px-20">
      ...
      <div className="text-left">
        <h2 className="md:text-[20px] text-[14px] font-jakarta-sans font-bold mb-4">Disclaimer</h2>
        <p className="text-[10px] md:text-[16px] pe-7 text-justify font-medium font-jakarta-sans leading-[140%]">

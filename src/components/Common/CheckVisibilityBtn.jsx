...
const CheckVisibilityBtn = () => {
  ...
  const onClose = () => {
    ...
    return (
      <>
      {
        isOpen && <AssessmentForm  onClose={onClose}/>
      }
        <button onClick={() => setIsOpen(true)} className="relative text-[16px] w-[256px] h-[56px] text-center font-semibold text-[#E8ECFE] bg-[#1641F1] hover:shadow-[0px_4px_20px_rgba(0,0,255,0.3)] rounded-full overflow-hidden group/button">
